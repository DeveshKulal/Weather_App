            ...
            child: Stack(
              children: [
                Padding(
                  ...
                  child: Align(
                      alignment: AlignmentDirectional(22, -0.85),
                      child: Container(
                        height: 300,
                        width: 300,
                ...
                Stack(children: [
                    ...
                    child: ClipPath(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                            height: 88,
                            decoration: BoxDecoration(
                              color: Color(0xff48319D).withOpacity(0.3),
                              border: Border.all(
                                  width: 2, color: Color(0xff3A3A6A)),
                            )),
                      ),
                    ),
                  ),
                    ...
                    child: ClipPath(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(0xff48319D).withOpacity(0.3),
                            border:
                                Border.all(width: 2, color: Color(0xff3A3A6A)),
                          )),
                    ),
                  ),
                  ...
                  //left button
                  Align(
                    alignment: AlignmentDirectional(-0.8, 1.03),
                    child: IconButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                  ...
                  // right button
                  Align(
                    alignment: AlignmentDirectional(0.83, 1.035),
                    child: IconButton(
                      onPressed: () {
                        Navigator.push(
                            context,
